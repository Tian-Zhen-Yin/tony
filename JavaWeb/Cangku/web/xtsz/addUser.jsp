...
%>
	...
	<tr><td  height="34">
      ...
      <form name="form1" method="post" action="updateUser.jsp">
        ...
        <tr><td>
          <div align="center">
            <input name="submit" type="button" class="btn_grey" value="确认注册" onClick="check()">
...
function check()
{
  if(form1.username.value==0){
    alert("请输入用户名");form1.username.focus();
    return;
  }
  if(form1.newpw1.value==0){
    alert("请输入密码");form1.newpw1.focus();
    return;
  }
  if(form1.newpw2.value==0){
    alert("请再次输入密码");form1.newpw2.focus();
    return;
  }
