...
<%
   ...
   String ckbh="ck"+calendar.getDateString()+new Random().nextInt(999);
%>
  <center><img src="../KCM/sprk.gif"></center>
    ...
    <form  name="form2" method="post" action="sprkthChange.jsp" >
      <%
         ...
         session.setAttribute("ckbh",ckbh);
      ...
      %>
        ...
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;出库日期:<input type="text" name="rkdate" readonly value="<%=calendar.getDate()%>">
              <font color="#585858"></font></td>
